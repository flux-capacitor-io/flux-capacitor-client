...
/**
 * Annotation to be placed on methods in commands or queries. After an aggregate is loaded and a {@link AggregateRoot} is
 * returned you can pass the command or query to the {@link AggregateRoot#assertLegal} method to assert whether or not the
