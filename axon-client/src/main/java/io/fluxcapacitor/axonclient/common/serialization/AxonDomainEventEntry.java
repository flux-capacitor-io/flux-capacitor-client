...
@Value
public class AxonDomainEventEntry implements DomainEventData<byte[]> {
    ...
    public String getType() {
        return axonMessage.getDomain();
    }

    @Override
    public String getAggregateIdentifier() {
        return axonMessage.getAggregateId();
    }

    @Override
    public long getSequenceNumber() {
        return axonMessage.getSequenceNumber();
    }
}
